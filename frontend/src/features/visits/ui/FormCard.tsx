...
export default function FormCard({ form, visitor, onSubmit, isLoading, error }: Props) {
  return (
      ...
      <form onSubmit={form.onSubmit(onSubmit)}>
        <Card.Section withBorder inheritPadding py="xs">
          <div className="flex justify-center md:justify-normal">
            <Text size="xl" fw={500}>
              Νέα Επίσκεψη : {visitor.name} {visitor.surname}
            </Text>
          </div>
        </Card.Section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ">
          <div className="md:w-[50%] mt-2 min-w-[190px] w-[80%] m-auto">
            <TextInput
              label="Αιτία επίσκεψης"
              withAsterisk
              placeholder="Προσθήκη αιτίας επίσκεψης"
              key={form.key('reason')}
          ...
          <div className="md:w-[50%] min-w-[190px] w-[80%] m-auto">
            <Textarea
              ...
              minRows={4}
              withAsterisk
              label="Κλινική Έξέταση"
              placeholder="Προσθήκη Κλινικής εξέτασης"
          ...
          <div className="md:w-[50%] min-w-[190px] w-[80%] m-auto">
            <Textarea
              ...
              placeholder="Προσθήκη Εργαστηριακού ελέγχου"
          ...
          <div className="m-auto col-span-1 md:col-span-2 mt-2 w-[80%] md:w-[55%]">
            <TextInput
              label="Διάγνωση"
              placeholder="Προσθήκη Διάγνωσης"
              withAsterisk
          ...
          <div className="col-span-1 md:col-span-2 m-auto w-[80%] md:w-[55%]">
            <Textarea
              autosize
              minRows={4}
              label="Συμπεράσματα/Οδηγίες"
              placeholder="Προσθήκη Οδηγιών"
              withAsterisk
